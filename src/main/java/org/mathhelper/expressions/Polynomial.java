...
public class Polynomial implements Cloneable {
    ...
    public Polynomial(@NonNull Map<Integer, Double> numeratorCoefficients,
                      @NonNull Map<Integer, Double> denominatorCoefficients) {
        setNumeratorCoefficients(new HashMap<>(numeratorCoefficients));
        setDenominatorCoefficients(new HashMap<>(denominatorCoefficients));
    }
    ...
    public void multiply(@NonNull Map<Integer, Double> coefficients) {
        var initialNumerator = new HashMap<>(numeratorCoefficients);
        numeratorCoefficients.clear();
        for (var entry : initialNumerator.entrySet()) {

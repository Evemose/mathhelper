...
public class PolynomialTest {
    ...
    public void testMultiply() {
        var coefs1 = Map.of(0, 1.d, 1, 2.d);
        var p1 = new Polynomial(coefs1);
        var coefs2 = Map.of(0, 1.d, 1, 3.d);
        p1.multiply(coefs2);
        assertThat(p1.getNumeratorCoefficients()).containsExactlyInAnyOrderEntriesOf(Map.of(0, 1.d, 1, 5.d, 2, 6.d));
    }
    ...
    public void testMultiply_EmptyCoefficients() {
        var numeratorCoefficients1 = Map.of(2, 1.0, 1, -3.0, 3, -4.0);
        var denominatorCoefficients1 = Map.of(0, 4.0);
        var poly1 = new Polynomial(numeratorCoefficients1, denominatorCoefficients1);

        var coefs2 = new HashMap<Integer, Double>();
        poly1.multiply(coefs2);
        assertThat(poly1.getNumeratorCoefficients()).isEmpty();
    }
